    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Verify Transaction">
      <div className="flex gap-6">
        <div>
          ...
          <Image src="/image/payment-proof-dummy.png" alt="payment proof" width={200} height={400} />
        </div>
        <div>
          <h4 className="font-semibold text-sm mb-2">
            Order Details
          ...
          <div className="bg-gray-100 rounded-md flex flex-col gap-2.5 p-4 text-sm mb-5">
            ...
            <div className="flex justify-between font-medium">
              ...
              <div className="text-right">+123456789</div>
            </div>
          ...
          <div className="border-gray-200 rounded-lg p-2 flex items-center gap-2">
            <div className="bg-gray-100 rounded aspect-square w-8 h-8">
              <Image src="/image/products/product-1.png" width={30} height={30} alt="product image"/>
            </div>
