    ...
    <div>
      <div className="flex justify-between items-center mb-10">
        <div>
          ...
          <p className="opacity-50">Manage destination account for customer transfers.</p>
        </div>
      ...
      <DeleteModal isOpen={isDeleteModalOpen} onClose={()=>setIsDeleteModalOpen} onConfirm={handleDeleteConfirm}/>
    </div>
  );
};
