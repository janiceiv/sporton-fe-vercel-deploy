...
const PaymentSteps = () => {
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      alert("Transaction created successfuly")
      reset();
    ...
    <CardWithHeader title="Payment Steps">
      <div className="p-5">
        <ol className="list-decimal text-xs pl-2 flex flex-col gap-4 mb-5">
          <li>
            Transfer the total amount of <b>Rp. 1.035.000</b> to your preferred bank account listed under &apos;Payment Options&apos; (BCA, Mandiri, or BRI).
          </li>
          <li>
