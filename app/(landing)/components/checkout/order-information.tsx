    ...
    <CardWithHeader title="Order Information">
      <div className="p-5">
        ...
        <div className="input-group">
          ...
          <textarea placeholder="Type your shipping address" name="customerAddress" id="customerAddress" rows={7} value={formData.customerAddress} onChange={handleInputChange}/>
        </div>
      </div>
    </CardWithHeader>
  )
